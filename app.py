...
with tab4:
    ...
    if not stock_data.empty:
        ...
        hist_colors = ["#10b98180" if h >= 0 else "#ef444480" for h in histogram]
        fig_macd.add_trace(go.Bar(x=idx, y=list(histogram), name="Histogram", marker=dict(color=hist_colors)))
        ...
        fig_macd.update_layout(paper_bgcolor="#f8fafc", plot_bgcolor="#f8fafc", font=dict(color="#1e2937"),
                               height=260, xaxis=dict(gridcolor="#e2e8f0"), yaxis=dict(gridcolor="#e2e8f0", title="MACD"))
